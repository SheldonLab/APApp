...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //send button
        Button forceButton = (Button) findViewById(R.id.button2);
        forceButton.setOnClickListener(forceListener);
    ...
    private OnClickListener forceListener = new OnClickListener() {
        public void onClick(View v) {

            RequestParams params = new RequestParams();
            params.put("please", "push");

            AsyncHttpClient client = new AsyncHttpClient();
            client.setMaxRetriesAndTimeout(2, 2000);
            client.post("http://52.91.240.90:8000/push", params, new AsyncHttpResponseHandler() {
                        @Override
                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                            stopService(successIntent);
                            startService(successIntent);
